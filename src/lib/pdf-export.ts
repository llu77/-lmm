 ...
 */
function addPaginationFooters(doc: jsPDF): void {
...
/**
 * معالج إخراج PDF موحد - يدعم التحميل والطباعة
 */
async function outputPDF(
  doc: jsPDF,
  options: { mode: PDFOutputMode; fileName: string }
): Promise<void> {
...
/**
 * دالة أساسية لإنشاء تقرير الإيرادات - تدعم التحميل والطباعة
 */
async function createRevenuePDF(
  data: RevenueData[],
  branchName: string,
  startDate: Date,
  endDate: Date,
...
export async function generateRevenuesPDF(
  ...
  return createRevenuePDF(data, branchName, startDate, endDate, config, 'download');
}
...
export async function printRevenuesPDF(
  ...
  return createRevenuePDF(data, branchName, startDate, endDate, config, 'print');
}

// ================== Expenses PDF ==================

/**
 * دالة أساسية لإنشاء تقرير المصروفات - تدعم التحميل والطباعة
 */
async function createExpensesPDF(
  data: ExpenseData[],
  branchName: string,
  config: Partial<PDFConfig>,
  mode: PDFOutputMode
...
export async function generateExpensesPDF(
  ...
  return createExpensesPDF(data, branchName, config, 'download');
}
...
export async function printExpensesPDF(
  ...
  return createExpensesPDF(data, branchName, config, 'print');
}

// ================== Product Orders PDF ==================

/**
 * دالة أساسية لإنشاء فاتورة طلب منتجات - تدعم التحميل والطباعة
 */
async function createProductOrderPDF(
...
export async function generateProductOrderPDF(
  ...
  return createProductOrderPDF(order, config, 'download');
}
...
export async function printProductOrderPDF(
  ...
  return createProductOrderPDF(order, config, 'print');
}

// ================== Payroll Functions ==================

/**
 * دالة أساسية لإنشاء مسير الرواتب - تدعم التحميل والطباعة
 */
...
export async function generatePayrollPDF(
  ...
  return createPayrollPDF(payrollData, config, 'download');
}
...
export async function printPayrollPDF(
  ...
  return createPayrollPDF(payrollData, config, 'print');
}
