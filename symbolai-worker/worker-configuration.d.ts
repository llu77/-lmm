/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config wrangler.toml` (hash: 6e9944b9cdf55ebd844ba8d2a74ed3a0)
// Runtime types generated with workerd@1.20251109.0 2024-10-22 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		...
		AI_GATEWAY_NAME: "symbolai-enhanced" | "symbolai-enhanced-preview";
		EMAIL_FROM: "info@symbolai.net" | "preview@symbolai.net";
		EMAIL_FROM_NAME: "SymbolAI" | "SymbolAI Preview";
		ADMIN_EMAIL: "admin@symbolai.net";
		routes: [{"pattern":"symbolai.net/*","zone_name":"symbolai.net"},{"pattern":"*.symbolai.net/*","zone_name":"symbolai.net"}];
		CloudflareMCPAgent: DurableObjectNamespace /* CloudflareMCPAgent from symbolai-worker */;
		...
		AI: Ai;
		ASSETS: Fetcher;
		WORKFLOWS: Workflow /* FinancialWorkflow */;
		D1_MIGRATION_WORKFLOW: Workflow /* D1MigrationWorkflow */;
		KV_BATCH_WORKFLOW: Workflow /* KVBatchWorkflow */;
	}
}
